...
def dec_decrypt_byte_as_nibbles( nibble_quadruple, key_quadruple ):
    ...
    ans1 = dec_xor(nibble_quadruple, key_quadruple)
    ans2 = dec_swap_last_two(ans1)
    ans3 = dec_s_box(ans2)
    ans4 = dec_xor(ans3,key_quadruple)
    ans5 = dec_subtract_last_two_first_two(ans4)
    ans6 = dec_swap_last_two(ans5)
    ans7 = dec_s_box(ans6)
    ans8 = dec_xor(ans7, key_quadruple)
